...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://3patiblueapp.com.pk/3-patti-blue-for-pc",
  },
  openGraph: {
    title: '3Patti Blue for PC Download Latest Version Free 2026',
...
export default function CardRummyForPCPage() {
  ...
  const schemaData = {
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://3patiblueapp.com.pk/3-patti-blue-for-pc"
    },
    "about": {
