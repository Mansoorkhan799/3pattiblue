      ...
      <article className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <ol className="list-decimal pl-6 text-gray-300 mb-6 space-y-3">
            <li>Register your 3Patti Blue account (see our <Link href="/blog/create-3-patti-blue-account-and-login" className="text-[#FFA500] hover:underline font-semibold">account creation guide</Link>)</li>
            <li>Make your first deposit (minimum ₨300) - learn about <Link href="/deposit-money-in-3-patti-blue" className="text-[#FFA500] hover:underline font-semibold">depositing money</Link></li>
