    ...
    <main className="min-h-screen bg-[#060A20]">
      <article className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert prose-lg max-w-none">
          ...
          <p className="text-gray-300 mb-4">
            For a complete guide on using the app safely, see our <Link href="/blog/how-to-use-3-patti-blue-app-pakistan-guide-2026" className="text-[#FFA500] hover:underline font-semibold">beginner's guide</Link> and <Link href="/blog/responsible-gaming-guide-3-patti-blue" className="text-[#FFA500] hover:underline font-semibold">responsible gaming guide</Link>.
          </p>
          ...
          <div className="mt-12 text-center">
            <Link 
              href="/blog/responsible-gaming-guide-3-patti-blue"
