...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://3patiblueapp.com.pk/withdraw-money-from-3-patti-blue',
  },
};
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex justify-center mt-10">
              <Image
                ...
                alt="3Patti Blue - How to Withdraw Money"
                width={220}
                height={220}
