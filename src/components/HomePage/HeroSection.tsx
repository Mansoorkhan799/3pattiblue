    ...
    <>
      ...
      <section className="py-8 md:py-16 px-4 md:px-8 max-w-7xl mx-auto" style={{ minHeight: '400px' }}>
        <div className="md:flex md:items-start md:justify-between md:space-x-12 lg:space-x-20">
          ...
          {/* LCP Hero Image wrapped in ImageObject schema markup */}
          <div className="md:w-1/2 mt-12 md:mt-0 flex justify-center items-center">
            ...
            >
              <Image
                ...
                title="3 Patti Blue – Official App"
                width={280}
                height={280}
              ...
              <figcaption className="sr-only" itemProp="caption">
                3 Patti Blue — Pakistan's most trusted Teen Patti gaming app. Download the official APK and win real money.
              </figcaption>
              <meta itemProp="url" content="https://3patiblueapp.com.pk/3-patti-blue.webp" />
