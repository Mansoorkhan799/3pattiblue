...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Sections
    'section.downloadInfo': 'Download Information',
    'section.overview': 'Overview',
    'section.understanding': 'What is 3Patti Blue APK?',
    ...
    'section.download': 'How to Download 3Patti Blue APK?',
    ...
    'content.install.title': 'Installation Guide',
    ...
    'content.registrationGuide.title': 'How to Register and Login to 3Patti Blue APK?',
    ...
    'content.withdraw.title': 'How to Withdraw Money from 3Patti Blue?',
    ...
    // Expert Tips
    'tips.title': '3Patti Blue Tips & Tricks',
